...
// insert into to database - get all plants from Plant table
    ...
    new sql.ConnectionPool(database.config).connect().then(pool => {
        ...
        if(req.body.SiteIdNumber.length < 5){
            siteIdNum = "'" + req.body.SiteIdNumber + "'"
        } else {
            siteIdNum = "right(" + "'" + req.body.SiteIdNumber + "'" + ", len(" + "'" + req.body.SiteIdNumber + "'" + ") - charindex('='," + "'" + req.body.SiteIdNumber + "'" + '))'
        }
        ...
        if (req.query.table == 'environmental') {
            querycode = 'INSERT INTO Environmental_Swabs OUTPUT Inserted.EnvironmentalSwabID VALUES ' + "('" + req.body.Plant + "'," + "'" + req.body.DateCollected + "'," + "'" + req.body.TimeCollected + "'," + "'" + req.body.Type + "'," + siteIdNum + ",'" + req.body.LocationDescription + "'," + "'" + req.body.ListeriaResult + "'," + "'" + req.body.SalmonellaResult + "'," + "'" + req.body.Comment + "') UPDATE Username set Plant = " + req.body.Plant + ", SampleType =" + "'" + req.body.Type + "'" + " where Username=" + "'" + (req.connection.user).replace(/JVAPP\\/g, "").toLowerCase().replace(/resers\\/g, "") + "'"
        }
